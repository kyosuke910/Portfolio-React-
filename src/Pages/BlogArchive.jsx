...
export const BlogArchive = () => {
  ...
  const ArchiveDate = idParam.slice(1)
  ...
  return(
    <>
      ...
      <SMainArea>
        <SImgArea>
          <SImg src="/images/blog/blogListTop.png" alt="アーカイブページトップ画像" />
          <STitle className="subContentsTitle">Archive</STitle>
        </SImgArea>
        <SCategoryTitle>{`${ArchiveDate.substr(0,4)}年${ArchiveDate.substr(5,2)}月`}</SCategoryTitle>
        <SBlogListArea>
          <SContentArea>
          {blogs.map(blog => (
          ...
          <SSidebarArea>
              <SSidebarLabel>Archive</SSidebarLabel>
              <ul>
